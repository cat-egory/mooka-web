    ...
    <>
      ...
      <section className="header relative pt-16 items-center flex h-screen max-h-860-px">
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4 z-10">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                감상한 영화, 책, 드라마를 기록하는 공간
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-gray-500">
                평소 본 영화, 책, 드라마들을 기록하고 연말에 회고할 때 편한
                서비스가 없을까 해서 만든 사이트
              </p>
              <div className="mt-12">
                <a
        ...
        <img
          className="absolute top-95-px b-auto right-0 pt-16 sm:w-6/12 w-10/12 -mt-48 sm:mt-0 max-h-860-px z-2 opacity-80"
          src="/img/chris-bair-S8FOtAmjJYY-unsplash.jpg"
          alt="mooka front image"
        />
      </section>
